...
export default function Services() {
    ...
    return (
        <main className="services">
            ...
            <h1 className='services__h1 text-uppercase'>Mes services</h1>
            <p className='services__principal-text'>Création de solutions web modernes, performantes et sur mesure.</p>
            ...
            <div className='services__list'>
                <section className='services__service' onMouseEnter={hover} onMouseLeave={noHover}>
                    ...
                    <p className='services__text-service'>Réalisation de <strong>wireframes</strong> et de <strong>prototypes</strong> avec <span className='services__underline-text'>Figma</span>.</p>
                </section>
                <section className='services__service' onMouseEnter={hover} onMouseLeave={noHover}>
                    ...
                    <p className='services__text-service'>Développement d&apos;interfaces web <strong>responsives</strong> et <strong>dynamiques</strong> en <span className='services__underline-text'>HTML</span>, <span className='services__underline-text'>CSS</span> et <span className='services__underline-text'>JavaScript</span>, ainsi qu&apos;avec des <strong>frameworks</strong> modernes tels que <span className='services__underline-text'>React</span>, <span className='services__underline-text'>Angular</span> et <span className='services__underline-text'>Vue.js</span>.</p>
                </section>
                <section className='services__service' onMouseEnter={hover} onMouseLeave={noHover}>
                    ...
                    <p className='services__text-service'>Développement d&apos;applications web avec <strong>rendu côté serveur</strong> en <span className='services__underline-text'>PHP (Symfony)</span> et <span className='services__underline-text'>Python (Django)</span> ainsi que conception d&apos;<strong>API REST</strong> en <span className='services__underline-text'>Node.js</span> avec <span className='services__underline-text'>Express</span>.</p>
                </section>
                <section className='services__service' onMouseEnter={hover} onMouseLeave={noHover}>
                    <svg className='services__icon-service' xmlns="http://www.w3.org/2000/svg" height="40" width="41" viewBox="0 0 640 640">
                        {/* <!--!Font Awesome Free v7.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--> */}
                    ...
                    <h2 className='services__h2 text-uppercase'>Bases de données</h2>
                    <p className='services__text-service'>Utilisation des bases de données <strong>relationnelles</strong> (<span className='services__underline-text'>MariaDB</span>) et <strong>non-relationnelles</strong> (<span className='services__underline-text'>MongoDB</span>) pour la gestion et la persistance des données.</p>
                </section>
            </div>
        </main>
    )
